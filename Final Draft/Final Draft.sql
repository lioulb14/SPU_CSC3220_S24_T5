--
-- File generated with SQLiteStudio v3.4.4 on Sun May 12 23:10:38 2024
--
...
-- Table: features
CREATE TABLE IF NOT EXISTS features (featuresId INTEGER PRIMARY KEY AUTOINCREMENT, "Delete" ANY, "quick-copy" TEXT UNIQUE, oneclickLogin TEXT UNIQUE) STRICT;
...
-- Table: Password
CREATE TABLE IF NOT EXISTS Password (passwordId INTEGER PRIMARY KEY AUTOINCREMENT, website TEXT UNIQUE NOT NULL, username TEXT UNIQUE NOT NULL, SavePass TEXT NOT NULL UNIQUE, GeneratePass TEXT UNIQUE, RetrievePass TEXT UNIQUE, featuresID INTEGER REFERENCES features (featuresId)) STRICT;
